...
plot_fit_non_stationary_evd_mixture_model <- function(evd_mixture_model_object,
  ...
  # evd_mixture_model_object: an object associated with a result of the function "fit_non_stationary_evd_mixture_model()"
  # data_index:
  # nclass:
  # display_all:
...
# 
# 
# evd_mixture_model_object <- fit_non_stationary_evd_mixture_model(x = x,
#                                                                 covariates = covariates,
#                                                                 location.fun = ~ random,
#                                                                 scale.fun = ~ 1,
#                                                                 shape.fun = ~1,
...
# 
# evd_mixture_model_object$cluster_models
# 
...
# 
# evd_mixture_model_object$loglik
# 
