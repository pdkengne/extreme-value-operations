...
source("./src/estimate_several_gev_models_nonstationary.R")
...
estimate_gev_mixture_model_parameters_nonstationary <- function(x, 
                                                                block_sizes = NULL,
                                                                minimum_nblocks = 50,
                                                                threshold = NULL,
                                                                nlargest = Inf,
  ...
  equivalent_block_sizes_object<- estimate_several_standardized_block_maxima_mean_nonstationary(x = data_largest, 
  ...
  gev_models <- estimate_several_gev_models_nonstationary(x = data_largest, 
...
# 
# results <- estimate_gev_mixture_model_parameters_nonstationary(x, 
#                                                                block_sizes = NULL,
#                                                                minimum_nblocks = 50,
#                                                                threshold = NULL,
#                                                                nlargest = nlargest,
...
# plot_several_standardized_block_maxima_mean_nonstationary(x = results$data_largest,
