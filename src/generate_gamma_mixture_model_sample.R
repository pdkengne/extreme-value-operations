...
generate_gamma_mixture_model_sample <- function(n = 1, 
                                                scales, 
                                                shapes, 
                                                weights, 
  ...
  if (kind == "arithmetic"){
    ...
    output <- sapply(1:n, function(j){
      out <- sapply(1:length(weights), function(k){
        ...
        random_value <- qgamma(p = power_random_variates, 
                               scale = scales[k], 
                               shape = shapes[k])
...
# n <- 10000
# 
# results_1 <- generate_gamma_mixture_model_sample(n = n,
#                                                  scales,
#                                                  shapes,
#                                                  weights,
...
# #results_1
# 
# pdf_1 <- calculate_gamma_mixture_model_pdf(x = sort(results_1),
#                                            scales,
#                                            shapes,
#                                            weights,
#                                            kind = c("geometric", "arithmetic")[2])
...
# 
# 
# results_2 <- generate_gamma_mixture_model_sample(n = n,
#                                                  scales,
#                                                  shapes,
#                                                  weights,
#                                                  kind = c("geometric", "arithmetic")[1])
...
# #results_2
# 
# pdf_2 <- calculate_gamma_mixture_model_pdf(x = sort(results_2),
#                                            scales,
#                                            shapes,
#                                            weights,
#                                            kind = c("geometric", "arithmetic")[1])
...
# 
# 
# results <- generate_gamma_mixture_model_sample(n = n,
#                                                scales,
#                                                shapes,
#                                                weights,
#                                                kind = "merge")
