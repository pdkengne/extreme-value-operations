...
source("./src/plot_normalized_gev_probability.R")
source("./src/plot_normalized_gev_mixture_model_probability.R")

plot_gev_mixture_model_probability <- function(gev_mixture_model, 
                                       type = NULL,
                                       model_wise = FALSE,
                                       zoom = FALSE,
  ...
  if (is.element(el = type, set = weighted_gev_model_types) & !model_wise){
    plot_normalized_gev_probability(x = uvdata, 
  ...
  if (is.element(el = type, set = weighted_gev_model_types) & model_wise){
    plot_normalized_gev_mixture_model_probability(x = uvdata, 
