source("./src/calculate_student_mixture_model_inverse_cdf.R")

generate_student_mixture_model_sample <- function(n = 1, 
                                                  locations, 
                                                  scales,
                                                  shapes,
                                                  weights, 
  ...
  if (kind == "arithmetic"){
    ...
    output <- sapply(1:n, function(j){
      out <- sapply(1:length(weights), function(k){
        ...
        random_value <- extraDistr::qlst(p = power_random_variates, 
                                         mu = locations[k], 
                                         sigma = scales[k],
                                         df = shapes[k])
...
# # example 1
# 
# source("./src/calculate_student_mixture_model_pdf.R")
# 
# weights <- c(0.5, 0.5)
# 
# scales <- c(1, 1)
...
# n <- 10000
# 
# results_1 <- generate_student_mixture_model_sample(n = n,
#                                                    locations,
#                                                    scales,
#                                                    shapes,
#                                                    weights,
...
# #results_1
# 
# pdf_1 <- calculate_student_mixture_model_pdf(x = sort(results_1),
#                                              locations,
#                                              scales,
#                                              shapes,
#                                              weights,
...
# 
# 
# results_2 <- generate_student_mixture_model_sample(n = n,
#                                                    locations,
#                                                    scales,
#                                                    shapes,
#                                                    weights,
...
# #results_2
# 
# pdf_2 <- calculate_student_mixture_model_pdf(x = sort(results_2),
#                                              locations,
#                                              scales,
#                                              shapes,
#                                              weights,
...
# 
# 
# results <- generate_student_mixture_model_sample(n = n,
#                                                  locations,
#                                                  scales,
#                                                  shapes,
#                                                  weights,
