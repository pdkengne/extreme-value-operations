source("./src/calculate_logistic_mixture_model_inverse_cdf.R")

generate_logistic_mixture_model_sample <- function(n = 1, 
                                                   locations, 
                                                   scales, 
                                                   weights, 
  ...
  if (kind == "arithmetic"){
    ...
    output <- sapply(1:n, function(j){
      out <- sapply(1:length(weights), function(k){
        ...
        random_value <- qlogis(p = power_random_variates, 
                               location = locations[k], 
                               scale = scales[k])
...
# # example 1
# 
# source("./src/calculate_logistic_mixture_model_pdf.R")
# 
# weights <- c(0.5, 0.5)
# 
# scales <- c(1, 1)
...
# n <- 10000
# 
# results_1 <- generate_logistic_mixture_model_sample(n = n,
#                                                   locations,
#                                                   scales,
#                                                   weights,
...
# #results_1
# 
# pdf_1 <- calculate_logistic_mixture_model_pdf(x = sort(results_1),
#                                             locations,
#                                             scales,
#                                             weights,
#                                             kind = c("geometric", "arithmetic")[2])
...
# 
# 
# results_2 <- generate_logistic_mixture_model_sample(n = n,
#                                                   locations,
#                                                   scales,
#                                                   weights,
#                                                   kind = c("geometric", "arithmetic")[1])
...
# #results_2
# 
# pdf_2 <- calculate_logistic_mixture_model_pdf(x = sort(results_2),
#                                             locations,
#                                             scales,
#                                             weights,
#                                             kind = c("geometric", "arithmetic")[1])
...
# 
# 
# results <- generate_logistic_mixture_model_sample(n = n,
#                                                 locations,
#                                                 scales,
#                                                 weights,
#                                                 kind = "merge")
