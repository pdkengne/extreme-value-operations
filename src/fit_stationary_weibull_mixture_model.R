...
fit_stationary_weibull_mixture_model <- function(x, 
  ...
  cluster_models <- estimate_weibull_cluster_models(x = x, cluster_data = initial_cluster_data)
  ...
  while (!condition){
    ...
    cluster_models <- estimate_weibull_cluster_models(x = x, cluster_data = cluster_data_list)
