...
generate_lgamma_mixture_model_sample <- function(n = 1, 
                                                 scales, 
                                                 shapes, 
                                                 weights, 
...
# n <- 10000
# 
# results_1 <- generate_lgamma_mixture_model_sample(n = n,
#                                                   scales,
#                                                   shapes,
#                                                   weights,
...
# #results_1
# 
# pdf_1 <- calculate_lgamma_mixture_model_pdf(x = sort(results_1),
#                                             scales,
#                                             shapes,
#                                             weights,
#                                             kind = c("geometric", "arithmetic")[2])
...
# 
# 
# results_2 <- generate_lgamma_mixture_model_sample(n = n,
#                                                   scales,
#                                                   shapes,
#                                                   weights,
#                                                   kind = c("geometric", "arithmetic")[1])
...
# #results_2
# 
# pdf_2 <- calculate_lgamma_mixture_model_pdf(x = sort(results_2),
#                                             scales,
#                                             shapes,
#                                             weights,
#                                             kind = c("geometric", "arithmetic")[1])
...
# 
# 
# results <- generate_lgamma_mixture_model_sample(n = n,
#                                                 scales,
#                                                 shapes,
#                                                 weights,
#                                                 kind = "merge")
