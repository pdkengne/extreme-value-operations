...
calculate_lgamma_mixture_model_cdf <- function(q, 
                                               scales,
                                               shapes,
                                               weights, 
...
# scales <- rexp(n = p)
# 
# results <- calculate_lgamma_mixture_model_cdf(q = 10,
#                                              scales,
#                                              shapes,
#                                              weights,
#                                              kind = c("geometric", "arithmetic")[1])
...
# 
# 
# results <- calculate_lgamma_mixture_model_cdf(q = c(2, 3, 5, 7, 11, 13, 17, 19),
#                                              scales,
#                                              shapes,
#                                              weights,
#                                              kind = c("geometric", "arithmetic")[1])
