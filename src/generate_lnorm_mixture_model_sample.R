...
generate_lnorm_mixture_model_sample <- function(n = 1, 
                                                locations, 
                                                scales, 
                                                weights, 
  ...
  # The vectors of parameters locationst have the same number of elements
  ...
  if (kind == "arithmetic"){
    ...
    output <- sapply(1:n, function(j){
      out <- sapply(1:length(weights), function(k){
        ...
        random_value <- qlnorm(p = power_random_variates, 
                               meanlog = locations[k], 
                               sdlog = scales[k])
...
# n <- 10000
# 
# results_1 <- generate_lnorm_mixture_model_sample(n = n,
#                                                  locations,
#                                                  scales,
#                                                  weights,
...
# #results_1
# 
# pdf_1 <- calculate_lnorm_mixture_model_pdf(x = sort(results_1),
#                                            locations,
#                                            scales,
#                                            weights,
#                                            kind = c("geometric", "arithmetic")[2])
...
# 
# 
# results_2 <- generate_lnorm_mixture_model_sample(n = n,
#                                                  locations,
#                                                  scales,
#                                                  weights,
#                                                  kind = c("geometric", "arithmetic")[1])
...
# #results_2
# 
# pdf_2 <- calculate_lnorm_mixture_model_pdf(x = sort(results_2),
#                                            locations,
#                                            scales,
#                                            weights,
#                                            kind = c("geometric", "arithmetic")[1])
...
# 
# 
# results <- generate_lnorm_mixture_model_sample(n = n,
#                                                locations,
#                                                scales,
#                                                weights,
#                                                kind = "merge")
