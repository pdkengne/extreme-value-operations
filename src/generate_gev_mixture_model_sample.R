...
generate_gev_mixture_model_sample <- function(n = 1, 
  ...
  if (kind == "arithmetic"){
    ...
    output <- calculate_gev_mixture_model_inverse_cdf(p = u, 
                                                      loc = locations, 
                                                      scale = scales, 
                                                      shape = shapes,
                                                      weights = weights,
...
# 
# 
# results_3 <- generate_gev_mixture_model_sample(n = n,
#                                                locations,
#                                                scales,
#                                                shapes,
#                                                weights,
...
# #results_3
# 
# pdf_3 <- calculate_gev_mixture_model_pdf(x = sort(results_3),
#                                          locations,
#                                          scales,
#                                          shapes,
#                                          weights,
